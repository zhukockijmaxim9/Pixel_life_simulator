...
Этот документ описывает основные механики Pixel Life Simulator на уровне правил.

Если вам нужна самая подробная версия “как устроено всё” (с числами/ограничениями/днями) — см. `docs/mechanics.md`.
